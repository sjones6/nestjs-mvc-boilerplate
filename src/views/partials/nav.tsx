...
function PublicMenu(props: INavProps) {
  return (
    <div>
      <a class="inline-block mx-2 hover:text-gray-700" href="/login">
        Login
      </a>
      <a
        class="inline-block mx-2 rounded text-white bg-black p-2 hover:bg-gray-700"
        href="/register"
      >
        Sign Up
      </a>
...
export function Nav(props: INavProps) {
  ...
  return (
    <nav class="bg-white py-2 px-4 width-full shadow">
